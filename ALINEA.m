...
u_rm_3=1;
k_gain=0.1;
u=[v_free,v_free,v_free,v_free,v_free,v_free,v_free,v_free,v_free,u_rm_1,u_rm_2,u_rm_3];Weather=[];
...
%     weather=(end_weather-initial_weather)/720*i+initial_weather;
    ...
    Rou_25=x(31);
    Rou_35=x(49);
    u_rm_1=Para_RM_control_law(k_gain,u_rm_1,rou_crit, Rou_15,1);
    u_rm_2=Para_RM_control_law(k_gain,u_rm_2,rou_crit, Rou_25,1);
    u_rm_3=Para_RM_control_law(k_gain,u_rm_3,rou_crit, Rou_35,1);
    u=[v_free,v_free,v_free,v_free,v_free,v_free,v_free,v_free,v_free,u_rm_1,u_rm_2,u_rm_3];
    for j=1:M
