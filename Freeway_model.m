function x_=Freeway_model(x, u, weather)
%% Initial conditions
rou_11=x(1);
v_11=x(2);
q_11=x(3);
...
% elseif weather==2
%     noise_15=random('Normal',-2,2);
%     noise_25=random('Normal',-2,2);
%     noise_35=random('Normal',-2,2);
% elseif weather==3
%     noise_15=random('Normal',-3,3);
%     noise_25=random('Normal',-3,3);
%     noise_35=random('Normal',-3,3);
% end
% % % if rou_15<=30
% % %     noise_15=random('Normal',-1,1);
...
% else
[tao, kai, yita_high, yita_low, rou_max, sigma, am, v_free, rou_crit, alpha, T, lambda, Lm, v_control, v_min, Co, ~, ~, ~,off_rate] = parameters_real(weather);
% end
