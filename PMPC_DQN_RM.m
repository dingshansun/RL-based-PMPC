state_space=[32 1]; % Continuous states
...
agent.AgentOptions.NumStepsToLookAhead=4;
...
env = rlFunctionEnv(obsInfo,actInfo,'DQN_RM_step','DQN_RM_reset');

trainOpts = rlTrainingOptions;
trainOpts.MaxEpisodes = 2000;
trainOpts.MaxStepsPerEpisode = 24;
